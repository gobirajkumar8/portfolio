...
const Balfour = () => (
  <section className="project-inner">
    ...
    <div className="project-description">
      Frontend Support for Magento 1 to Magento 2 migration product and category
      pages and checkout pages. Custome Bundle products attibutes filter and
      listing.
    </div>
    <footer>
