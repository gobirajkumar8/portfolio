...
const Murad = () => (
  <section className="project-inner">
    ...
    <h3 className="project-title">
      <a
        href="https://www.sharpertomorrow.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        Sharpertomorrow - MerchSource
      </a>
    </h3>
    <div className="project-description">
      Developed Custom theme and Dynamic Landing page and product pages in Pahse
      1. Phase 2 - Implementing Woo-commerce.
    </div>
    <footer>
