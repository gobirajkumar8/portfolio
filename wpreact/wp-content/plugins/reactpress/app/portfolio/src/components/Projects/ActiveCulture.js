...
const ActiveCulture = () => (
  <section className="project-inner">
    ...
    <h3 className="project-title">
      <a
        href="http://activeculturecafe.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        Balour
    ...
    <div className="project-description">
      Building a custom them for cafe compatible WordPress plugins online order
      with Third part portal https://www.hazlnut.com/
    </div>
    <footer>
