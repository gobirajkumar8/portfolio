...
/**
 * Template Name: Home
 * The template for displaying for Home pages.
 *
...
<?php do_action( 'sweetsi_lite_page_header' ); ?>

<main role="main" id="maincontent" class="py-5">
    <div class="container">
        <?php
        $sweetsi_lite_left_right = get_theme_mod( 'sweetsi_lite_single_page_sidebar_layout','One Column');
...
<?php do_action( 'sweetsi_lite_page_footer' ); ?>
