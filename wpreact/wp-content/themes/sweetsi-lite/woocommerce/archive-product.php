...
<?php
 $sweetsi_lite_shop_page_sidebar = get_theme_mod( 'sweetsi_lite_shop_page_sidebar',true );
 if ( false == $sweetsi_lite_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row m-0">
			...
			<?php if ( false != $sweetsi_lite_shop_page_sidebar ) {?>
